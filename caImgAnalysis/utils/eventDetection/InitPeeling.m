...
ca_p.onsettau=0.05;         % onset tau (s)
ca_p.offset=0;              % baseline offset (%)
ca_p.amp1=4.5;              % amplitude 1  (%)
ca_p.tau1=0.7;              % tau1 (s)
...
exp_p.noiseSD = 2.0;        % noise stdev of DF/F trace (in percent), should be specified by the user
