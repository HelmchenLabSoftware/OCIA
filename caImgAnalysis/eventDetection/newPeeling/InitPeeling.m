...
% flag for spike generation mode: 'linDFF' - simple linear DFF, or 'satDFF' - saturating indicator 
ca_p.ca_genmode = 'satDFF';
ca_p.ca_onsettau=0.02;      % Ca transient - onset tau (s)
ca_p.ca_amp=3500;           % Ca transient - total amplitude 1 (nM)
...
exp_p.noiseSD = 3;          % noise stdev of DF/F trace (in percent), should be specified by the user
exp_p.indicator = 'YCN140';  % calcium indicator
...
elseif strcmp(ca_p.ca_genmode, 'saturatDFF')
...
peel_p.smttbox = 4;          % Schmitt trigger - smoothing box size (in points)
