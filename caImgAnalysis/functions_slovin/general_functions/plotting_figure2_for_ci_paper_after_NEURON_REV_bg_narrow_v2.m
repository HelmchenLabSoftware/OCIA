...
figure;
scatter(mean(non(roi1,49:51),2)-1,mean(con(roi1,49:51),2)-1)
hold on
...
axis square
ranksum(mean(non(roi1,49:51),2)-1,mean(con(roi1,49:51),2)-1)

figure;
scatter(mean(non(roi2,49:51),2)-1,mean(con(roi2,49:51),2)-1)
hold on
plot(0:0.0001:3e-3,0:0.0001:3e-3,'k')
...
xlim([0 2e-3]);ylim([0 2e-3])
axis square
ranksum(mean(non(roi2,49:51),2)-1,mean(con(roi2,49:51),2)-1)
