...
figure;
scatter(mean(ball_V1(d_V1(1,1):d_V1(1,2),time),2)-1,mean(aall_V1(d_V1(1,1):d_V1(1,2),time),2)-1,16,'b');
hold on
scatter(mean(ball_V1(d_V1(2,1):d_V1(2,2),time),2)-1,mean(aall_V1(d_V1(2,1):d_V1(2,2),time),2)-1,16,'r');
scatter(mean(ball_V1(d_V1(3,1):d_V1(3,2),time),2)-1,mean(aall_V1(d_V1(3,1):d_V1(3,2),time),2)-1,16,'g');
scatter(mean(ball_V1(d_V1(4,1):d_V1(4,2),time),2)-1,mean(aall_V1(d_V1(4,1):d_V1(4,2),time),2)-1,16,'c');
scatter(mean(ball_V1(d_V1(5,1):d_V1(5,2),time),2)-1,mean(aall_V1(d_V1(5,1):d_V1(5,2),time),2)-1,16,'y');
xlim([-1e-3 2e-3]);ylim([-1e-3 2e-3]);
plot(-1e-3:0.0001:3e-3,-1e-3:0.0001:3e-3,'k')
ylabel('amplitude V1 collinear');xlabel('derivative V1 orthogonal');
...
figure;
scatter(mean(ball_V1_2(d_V1_2(1,1):d_V1_2(1,2),time),2)-1,mean(aall_V1_2(d_V1_2(1,1):d_V1_2(1,2),time),2)-1,16,'b');
hold on
scatter(mean(ball_V1_2(d_V1_2(2,1):d_V1_2(2,2),time),2)-1,mean(aall_V1_2(d_V1_2(2,1):d_V1_2(2,2),time),2)-1,16,'r');
scatter(mean(ball_V1_2(d_V1_2(3,1):d_V1_2(3,2),time),2)-1,mean(aall_V1_2(d_V1_2(3,1):d_V1_2(3,2),time),2)-1,16,'g');
scatter(mean(ball_V1_2(d_V1_2(4,1):d_V1_2(4,2),time),2)-1,mean(aall_V1_2(d_V1_2(4,1):d_V1_2(4,2),time),2)-1,16,'c');
scatter(mean(ball_V1_2(d_V1_2(5,1):d_V1_2(5,2),time),2)-1,mean(aall_V1_2(d_V1_2(5,1):d_V1_2(5,2),time),2)-1,16,'y');
xlim([-1e-3 2e-3]);ylim([-1e-3 2e-3]);
plot(-1e-3:0.0001:3e-3,-1e-3:0.0001:3e-3,'k')
...
figure;
scatter(mean(ball_V2(d_V2(1,1):d_V2(1,2),time),2)-1,mean(aall_V2(d_V2(1,1):d_V2(1,2),time),2)-1,16,'b');
hold on
scatter(mean(ball_V2(d_V2(2,1):d_V2(2,2),time),2)-1,mean(aall_V2(d_V2(2,1):d_V2(2,2),time),2)-1,16,'r');
scatter(mean(ball_V2(d_V2(3,1):d_V2(3,2),time),2)-1,mean(aall_V2(d_V2(3,1):d_V2(3,2),time),2)-1,16,'g');
scatter(mean(ball_V2(d_V2(4,1):d_V2(4,2),time),2)-1,mean(aall_V2(d_V2(4,1):d_V2(4,2),time),2)-1,16,'c');
scatter(mean(ball_V2(d_V2(5,1):d_V2(5,2),time),2)-1,mean(aall_V2(d_V2(5,1):d_V2(5,2),time),2)-1,16,'y');
xlim([-1e-3 2e-3]);ylim([-1e-3 2e-3]);
plot(-1e-3:0.0001:3e-3,-1e-3:0.0001:3e-3,'k')
