...
figure;
scatter(mean(non(roi_maskin,49:51),2)-1,mean(con(roi_maskin,49:51),2)-1)
hold on
plot(0:0.0001:3e-3,0:0.0001:3e-3,'k')
...
xlim([0 2e-3]);ylim([0 2e-3])
axis square
ranksum(mean(non(roi_maskin,49:51),2)-1,mean(con(roi_maskin,49:51),2)-1)
...
figure;
scatter(mean(non(roi_maskin,time),2)-1,mean(con(roi_maskin,time),2)-1)
hold on
plot(0:0.0001:3e-3,0:0.0001:3e-3,'k')
plot((0:0.0001:3e-3),(0:0.0001:3e-3)+top_bg,'r')
plot((0:0.0001:3e-3),(0:0.0001:3e-3)+bottom_bg,'r')
xlim([0 2e-3]);ylim([0 2e-3])
axis square
ranksum(mean(non(roi_maskin,time),2)-1,mean(con(roi_maskin,time),2)-1)
