%% three flankers: take only the gamma power for each trial



%cond4
load power_gamma_cond4
a=zeros(112,10000,size(power_gamma_cond4,3));
a(:,pixels,:)=power_gamma_cond4(1:112,:,:);
clear power_gamma_cond4
...
%cond3
load power_gamma_cond3
b=zeros(112,10000,size(power_gamma_cond3,3));
b(:,pixels,:)=power_gamma_cond3(1:112,:,:);
clear power_gamma_cond3
...
% %cond6
% load power_gamma_cond6
% c=zeros(112,10000,size(power_gamma_cond6,3));
% c(:,pixels,:)=power_gamma_cond6(1:112,:,:);
% clear power_gamma_cond6
% 
...
%cond2
load power_gamma_cond2
a=zeros(112,10000,size(power_gamma_cond2,3));
a(:,pixels,:)=power_gamma_cond2(1:112,:,:);
clear power_gamma_cond2
...
%cond4
load power_gamma_cond4
b=zeros(112,10000,size(power_gamma_cond4,3));
b(:,pixels,:)=power_gamma_cond4(1:112,:,:);
clear power_gamma_cond4
