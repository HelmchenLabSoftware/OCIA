%% three flankers: take only the alpha power for each trial



%cond4
load power_alpha_cond4
a=zeros(112,10000,size(power_alpha_cond4,3));
a(:,pixels,:)=power_alpha_cond4(1:112,:,:);
...
b=zeros(112,10000,size(power_alpha_cond3,3));
b(:,pixels,:)=power_alpha_cond3(1:112,:,:);
...
c=zeros(112,10000,size(power_alpha_cond6,3));
c(:,pixels,:)=power_alpha_cond6(1:112,:,:);
...
%cond2
load power_alpha_cond2
a=zeros(112,10000,size(power_alpha_cond2,3));
a(:,pixels,:)=power_alpha_cond2(1:112,:,:);
clear power_alpha_cond2
...
%cond4
load power_alpha_cond4
b=zeros(112,10000,size(power_alpha_cond4,3));
b(:,pixels,:)=power_alpha_cond4(1:112,:,:);
clear power_alpha_cond4
