...
coeff_circ_circ_cond1=mean(coeff_circle_cond1(:,:,tc),3);
clear coeff_circle_cond1
load coeff_circle_cond2
coeff_circ_circ_cond2=mean(coeff_circle_cond2(:,:,tc),3);
clear coeff_circle_cond2
load coeff_circle_cond4
coeff_circ_circ_cond4=mean(coeff_circle_cond4(:,:,tc),3);
clear coeff_circle_cond4
load coeff_circle_cond5
coeff_circ_circ_cond5=mean(coeff_circle_cond5(:,:,tc),3);
...
coeff_bg_bg_cond1=mean(coeff_bg_out_cond1(:,:,tb),3);
clear coeff_bg_out_cond1
load coeff_bg_out_cond2
coeff_bg_bg_cond2=mean(coeff_bg_out_cond2(:,:,tb),3);
clear coeff_bg_out_cond2
load coeff_bg_out_cond4
coeff_bg_bg_cond4=mean(coeff_bg_out_cond4(:,:,tb),3);
clear coeff_bg_out_cond4
load coeff_bg_out_cond5
coeff_bg_bg_cond5=mean(coeff_bg_out_cond5(:,:,tb),3);
