...
cont_distances_bg_bg(1:size(dist_vec,2),1:4)=dist_cont;
non_distances_bg_bg(1:size(dist_vec,2),1:4)=dist_non;
diff_distances_bg_bg(1:size(dist_vec,2),1:4)=dist_diff;
clear dist_diff dist_cont dist_non dist_vec
load corr_circ_circ_as_a_function_of_distance_1111cd
cont_distances_circ_circ(1:size(dist_vec,2),1:4)=dist_cont;
non_distances_circ_circ(1:size(dist_vec,2),1:4)=dist_non;
diff_distances_circ_circ(1:size(dist_vec,2),1:4)=dist_diff;
clear dist_diff dist_cont dist_non dist_vec
...
cont_distances_bg_bg(1:size(dist_vec,2),n)=dist_cont;
non_distances_bg_bg(1:size(dist_vec,2),n)=dist_non;
diff_distances_bg_bg(1:size(dist_vec,2),n)=dist_diff;
clear dist_diff dist_cont dist_non dist_vec
load corr_circ_circ_as_a_function_of_distance
cont_distances_circ_circ(1:size(dist_vec,2),n)=dist_cont;
non_distances_circ_circ(1:size(dist_vec,2),n)=dist_non;
diff_distances_circ_circ(1:size(dist_vec,2),n)=dist_diff;
clear dist_diff dist_cont dist_non dist_vec
...
figure;errorbar(distances,nanmean(diff_distances_bg_bg,2),nanstd(diff_distances_bg_bg,0,2)./sqrt(n3'))
hold on
plot(distances,zeros(1,50),'k')
xlim([0 7])
ylim([-0.04 0.02])
...
anova1(diff_distances_circ_circ(1:18,:)')
anova1(diff_distances_bg_bg(1:10,:)')
