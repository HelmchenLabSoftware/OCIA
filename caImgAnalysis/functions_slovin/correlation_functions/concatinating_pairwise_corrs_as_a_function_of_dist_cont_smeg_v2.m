...
cont_distances_bg_bg(1:size(dist_vec,2)-1,ses)=dist_cont;
non_distances_bg_bg(1:size(dist_vec,2)-1,ses)=dist_non;
diff_distances_bg_bg(1:size(dist_vec,2)-1,ses)=dist_diff;
clear dist_diff dist_cont dist_non dist_vec
load corr_circ_circ_as_a_function_of_distance
cont_distances_circ_circ(1:size(dist_vec,2)-1,ses)=dist_cont;
non_distances_circ_circ(1:size(dist_vec,2)-1,ses)=dist_non;
diff_distances_circ_circ(1:size(dist_vec,2)-1,ses)=dist_diff;
clear dist_diff dist_cont dist_non dist_vec
...
distances(1:size(dist_vec,2)-1)=dist_vec(2:end)*0.17;
clear dist_diff dist_cont dist_non dist_vec
...
figure;errorbar(distances,nanmean(diff_distances_bg_bg(:,ses1_smeg),2),nanstd(diff_distances_bg_bg(:,ses1_smeg),0,2)./sqrt(n3'),'r')
hold on
errorbar(distances,nanmean(diff_distances_circ_circ(:,ses1_smeg),2),nanstd(diff_distances_circ_circ(:,ses1_smeg),0,2)./sqrt(n1'),'b')
hold on
...
% anova1(diff_distances_circ_circ(1:20,ses1_smeg)')
% anova1(diff_distances_bg_bg(1:20,ses1_smeg)')
% 
% anova1(cont_distances_circ_circ(1:20,ses1_smeg)')
% anova1(cont_distances_bg_bg(1:20,ses1_smeg)')
% 
% anova1(non_distances_circ_circ(1:20,ses1_smeg)')
% anova1(non_distances_bg_bg(1:20,ses1_smeg)')
