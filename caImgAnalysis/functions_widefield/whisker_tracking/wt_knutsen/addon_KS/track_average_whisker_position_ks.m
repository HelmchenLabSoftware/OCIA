function varargout = track_average_whisker_position_ks(varargin)
g_tWT=varargin{1};
...
sDefFileName = [g_tWT.MovieInfo.Filename(1:end-7), g_tWT.MovieInfo.Filename(end-5:end-4) '_Whisker_Tracking'];
