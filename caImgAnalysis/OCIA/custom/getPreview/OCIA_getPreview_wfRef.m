function RGBIm = OCIA_getPreview_wfRef(this, iDWRow, ~)
% RGBIm = OCIA_getPreview_wfRef - [no description]
%
%       RGBIm = OCIA_getPreview_wfRef(this, iDWRow, previewType)
%
% [No description]
%
...
RGBIm = double(getData(this, iDWRow, 'wfRef', 'data'));
