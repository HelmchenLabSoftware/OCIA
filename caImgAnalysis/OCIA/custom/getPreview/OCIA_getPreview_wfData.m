function RGBIm = OCIA_getPreview_wfData(this, iDWRow, ~)
% RGBIm = OCIA_getPreview_wfData - [no description]
%
%       RGBIm = OCIA_getPreview_wfData(this, iDWRow, previewType)
%
% [No description]
%
...
RGBIm = double(getData(this, iDWRow, 'wf', 'data'));
