function OCIA_startFunction_processWatchFolderAndExtractNotebook(this)
% OCIA_startFunction_processWatchFolderAndExtractNotebook - [no description]
%
%       OCIA_startFunction_processWatchFolderAndExtractNotebook(this)
%
% [No description]
%
