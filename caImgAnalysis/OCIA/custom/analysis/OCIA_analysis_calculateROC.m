function [ROIAUCs, truePX, truePY, shufPX, shufPY, hashStruct] = OCIA_analysis_calculateROC(this, PSCaTraces, hashStruct)
% OCIA_analysis_calculateROC - [no description]
%
%       OCIA_analysis_calculateROC(this, iDWRows)
%
% [No description]
%
