function OCIA_analysis_ROIStat_corr(this, iDWRows)
...
... categ  id                   UIType      valueType               UISize      isLabAbove  label           tooltip
    ...
    'img', 'ROIStat2',          'dropdown', { 'responsiveness', 'response time', 'SI', 'd''' }, ...
                                                                    [0.75 0],   false,      'ROI Prop. 2',  'Selects which second ROI statistic should be plotted/analyzed.';
...
[ROIStat1, xLab] = OCIA_analysis_getROIStat(this.an.img.ROIStat, this.an.img.respMethod, PSCaTracesStats, stimIDIndexes, stimIDs);
% get the ROI statistic
[ROIStat2, yLab] = OCIA_analysis_getROIStat(this.an.img.ROIStat2, this.an.img.respMethod, PSCaTracesStats, stimIDIndexes, stimIDs);
...
plotROIStatCompare(this.GUI.handles.an.axe, ROIStat1, ROIStat2, grouping, groupLabels, '', plotLims, xLab, yLab, this.an.img.NVsNP1ShowFit);
