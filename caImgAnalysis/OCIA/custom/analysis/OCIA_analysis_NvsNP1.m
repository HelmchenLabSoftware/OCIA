function OCIA_analysis_NvsNP1(this, iDWRows)
...
... categ  id                   UIType      valueType               UISize      isLabAbove  label           tooltip
    ...
    'img', 'NVsNP1ShowFit',     'dropdown', { 'true', 'false' },    [0.75 0],   false,      'Show fit',     'Defines whether to show fitting or not.';
...
% get the ROINames grouping
[groupingROI, groupLabelsROI] = OCIA_analysis_getGrouping(this, iDWRows, stimIDIndexes, selDispStimIDs, 'ROI', ROINames);
...
plotROIStatNvsNP1(this.GUI.handles.an.axe, ROIStat, grouping, groupLabels, '', plotLims, yLab, this.an.img.NVsNP1ShowFit);
