function this = OCIA_config_batchSave_dayra_H30(this)
% OCIA_config_batchSave_dayra_H30 - "batchSave_dayra_H30" OCIA configuration file
%
%       this = OCIA('batchSave_dayra_H30')
%
% Configuration file for OCIA using the "batchSave_dayra_H30" configuration. This function should not be called directly
%   but rather using the "this = OCIA('batchSave_dayra_H30');" syntax to launch the software with this configuration.
%
