function this = OCIA_config_batchAnalysis_H6403b(this)
% OCIA_config_batchAnalysis_H6403b - "batchAnalysis_H6403b" OCIA configuration file
%
%       this = OCIA('batchAnalysis_H6403b')
%
% Configuration file for OCIA using the "batchAnalysis_H6403b" configuration. This function should not be called directly
%   but rather using the "this = OCIA('batchAnalysis_H6403b');" syntax to launch the software with this configuration.
%
