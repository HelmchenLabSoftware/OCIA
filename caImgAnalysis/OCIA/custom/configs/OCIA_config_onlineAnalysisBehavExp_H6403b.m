function this = OCIA_config_onlineAnalysisBehavExp_H6403b(this)
% OCIA_config_onlineAnalysisBehavExp_H6403b - "onlineAnalysisBehavExp_H6403b" OCIA configuration file
%
%       this = OCIA('onlineAnalysisBehavExp_H6403b')
%
% Configuration file for OCIA using the "onlineAnalysisBehavExp_H6403b" configuration. This function should not be called directly
%   but rather using the "this = OCIA('onlineAnalysisBehavExp_H6403b');" syntax to launch the software with this configuration.
%
...
this.GUI.dw.DWFilt = { 'mou_bl_150217_08' };
...
this.GUI.pos = [114, 336, 1743, 832]; % fullscreen
% this.GUI.pos = [9, 200, 1007, 539];
...
this.path.OCIASave = 'E:/Analysis/onlineAnalysis/';
...
this.path.remoteData = 'Z:/RawData/Balazs_Laurenczy/onlineAnalysis/';
