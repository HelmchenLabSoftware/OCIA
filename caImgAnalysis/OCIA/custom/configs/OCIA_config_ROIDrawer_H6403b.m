function this = OCIA_config_ROIDrawer_H6403b(this)
% OCIA_config_ROIDrawer_H6403b - "ROIDrawer_H6403b" OCIA configuration file
%
%       this = OCIA('ROIDrawer_H6403b')
%
% Configuration file for OCIA using the "ROIDrawer_H6403b" configuration. This function should not be called directly
%   but rather using the "this = OCIA('ROIDrawer_H6403b');" syntax to launch the software with this configuration.
%
...
this.GUI.dw.DWFilt = { 'mou_bl_141001_01', '2014_10_25', 'spot02', 'Imaging data', 'runType = Trial' };
