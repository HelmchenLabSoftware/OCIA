function this = OCIA_config_shankar(this)
% OCIA_config_shankar - "shankar" OCIA configuration file
%
%       this = OCIA('shankar')
%
% Configuration file for OCIA using the "shankar" configuration. This function should not be called directly
%   but rather using the "this = OCIA('shankar');" syntax to launch the software with this configuration.
%
...
this.main.startFunctionName = 'analysisPipeline_shankarROCAnalysis';
...
% this.path.OCIASave = 'E:/Work/Data/Analysis/';
...
... id                          label                                                       description
    ...
    'classifier',               'Neuron classfier',                                         'Classify neurons based on their responsiveness within different time periods';
    'AUROC',                    'Area under the curve ROC analysis',                        'Area under the curve ROC analysis';
