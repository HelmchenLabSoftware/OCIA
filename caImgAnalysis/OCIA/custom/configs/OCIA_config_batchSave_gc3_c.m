function this = OCIA_config_batchSave_gc3_c(this)
% OCIA_config_batchSave_gc3_c - "batchSave_gc3_c" OCIA configuration file
%
%       this = OCIA('batchSave_gc3_c')
%
% Configuration file for OCIA using the "batchSave_gc3_c" configuration. This function should not be called directly
%   but rather using the "this = OCIA('batchSave_gc3_c');" syntax to launch the software with this configuration.
%
...
this.path.OCIASave = '/home/gc3-user/HIFONASHE-02/Analysis/Balazs_Laurenczy/2015/1502_chronic/C/';
