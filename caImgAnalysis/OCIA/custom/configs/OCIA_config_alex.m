function this = OCIA_config_alex(this)
% OCIA_config_alex - "alex" OCIA configuration file
%
%       this = OCIA('alex')
%
% Configuration file for OCIA using the "alex" configuration. This function should not be called directly
%   but rather using the "this = OCIA('alex');" syntax to launch the software with this configuration.
%
