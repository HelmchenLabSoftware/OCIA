function this = OCIA_config_batchAnalysis_wenruiRCaMP(this)
% OCIA_config_batchAnalysis_wenruiRCaMP - "batchAnalysis_wenruiRCaMP" OCIA configuration file
%
%       this = OCIA('batchAnalysis_wenruiRCaMP')
%
% Configuration file for OCIA using the "batchAnalysis_wenruiRCaMP" configuration. This function should not be called directly
%   but rather using the "this = OCIA('batchAnalysis_wenruiRCaMP');" syntax to launch the software with this configuration.
%
...
% general parameters
this.main.startFunctionName = 'analysisPipeline_wenrui';
...
% this.path.OCIASave = 'F:\RawData\WenRui\2015_07_17__batchAnalysis\';
this.path.OCIASave = 'W:\Neurophysiology\Projects\RUNNING\RCaMP\Analysis\2015_09_03__Balazs\';
