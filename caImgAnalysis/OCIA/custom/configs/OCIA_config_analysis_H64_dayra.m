function this = OCIA_config_analysis_H64_dayra(this)
% OCIA_config_analysis_H64_dayra - "analysis_H64_dayra" OCIA configuration file
%
%       this = OCIA('analysis_H64_dayra')
%
% Configuration file for OCIA using the "analysis_H64_dayra" configuration. This function should not be called directly
%   but rather using the "this = OCIA('analysis_H64_dayra');" syntax to launch the software with this configuration.
%
...
this.main.startFunctionName = 'analysisPipeline_Dayra';
this.GUI.noGUI = false;
this.GUI.dw.DWFilt = { 'mou_dl_140604_03', '2014_06_21', 'spot01' };
% this.GUI.dw.DWFilt = { 'mou_dl_141227_03', '2015_01_14', 'spot02' };
...
% this.path.rawData = 'Z:/RawData/Dayra_Lorenzo/2014_07_chronic/';
