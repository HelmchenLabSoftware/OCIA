function this = OCIA_config_alexBatchSpontaneous
% OCIA_config_alexBatchSpontaneous - "alexBatchSpontaneous" OCIA configuration file
%
%       this = OCIA('alexBatchSpontaneous')
%
% Configuration file for OCIA using the "alexBatchSpontaneous" configuration. This function should not be called directly
%   but rather using the "this = OCIA('alexBatchSpontaneous');" syntax to launch the software with this configuration.
%
