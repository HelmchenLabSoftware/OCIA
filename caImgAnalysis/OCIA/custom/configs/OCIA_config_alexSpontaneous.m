function this = OCIA_config_alexSpontaneous(this)
% OCIA_config_alexSpontaneous - "alexSpontaneous" OCIA configuration file
%
%       this = OCIA('alexSpontaneous')
%
% Configuration file for OCIA using the "alexSpontaneous" configuration. This function should not be called directly
%   but rather using the "this = OCIA('alexSpontaneous');" syntax to launch the software with this configuration.
%
...
% this.GUI.dw.DWFilt = { 'P12', 'a3', 'r1s1', '', 'imgData' };
this.GUI.dw.DWFilt = { 'P11', 'a1', 'r1s2', '', 'imgData' };
...
this.path.rawData = 'W:/Neurophysiology/RawData/Alexander_vanderBourg/Whisker Stimulation/Juvenile/2013_10_22/';
...
this.dw.preProcessFunctionName = 'alexSpontaneous';
...
this.dw.watchTypes = cell2table({
    ...
    'spontaneous',       'RegionFolder', 'animal',   false,  'Spot folder',              '^spontaneous$';
    'reg',          'Region',       'spontaneous',   true,   'Spot folder',              '^r\ds\d$';
    ...
    'roiset',       'ROISet',       'spontaneous',   true,   'ROISet folder',            '^ROISets$';
...
% name of the stimuli
this.an.an.stimIDs = {'aH', 'dH', 'cH', 'aL', 'dL', 'cL', 'spontaneous'};
