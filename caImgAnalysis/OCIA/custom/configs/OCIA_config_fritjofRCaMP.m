function this = OCIA_config_fritjofRCaMP(this)
% OCIA_config_fritjofRCaMP - "fritjofRCaMP" OCIA configuration file
%
%       this = OCIA('fritjofRCaMP')
%
% Configuration file for OCIA using the "fritjofRCaMP" configuration. This function should not be called directly
%   but rather using the "this = OCIA('fritjofRCaMP');" syntax to launch the software with this configuration.
%
...
this.GUI.dw.DWFilt = { 'Mouse 0', '2014_04_17', 'Spot1_580' };
