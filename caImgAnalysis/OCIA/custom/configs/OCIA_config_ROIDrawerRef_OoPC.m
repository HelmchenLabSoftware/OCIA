function this = OCIA_config_ROIDrawerRef_OoPC(this)
% OCIA_config_ROIDrawerRef_OoPC - "ROIDrawerRef_OoPC" OCIA configuration file
%
%       this = OCIA('ROIDrawerRef_OoPC')
%
% Configuration file for OCIA using the "ROIDrawerRef_OoPC" configuration. This function should not be called directly
%   but rather using the "this = OCIA('ROIDrawerRef_OoPC');" syntax to launch the software with this configuration.
%
...
this.GUI.dw.DWFilt = { 'mou_bl_141001_01', '-', 'spot01', 'ROISet' };
