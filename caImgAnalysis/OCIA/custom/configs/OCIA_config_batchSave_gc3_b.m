function this = OCIA_config_batchSave_gc3_b(this)
% OCIA_config_batchSave_gc3_b - "batchSave_gc3_b" OCIA configuration file
%
%       this = OCIA('batchSave_gc3_b')
%
% Configuration file for OCIA using the "batchSave_gc3_b" configuration. This function should not be called directly
%   but rather using the "this = OCIA('batchSave_gc3_b');" syntax to launch the software with this configuration.
%
...
this.path.OCIASave = '/home/gc3-user/HIFONASHE-02/Analysis/Balazs_Laurenczy/2015/1502_chronic/B/';
