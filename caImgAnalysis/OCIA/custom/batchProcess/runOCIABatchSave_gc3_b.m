% runOCIABatchSave_gc3_b - [no description]
%
%       runOCIABatchSave_gc3_b()
%
% [No description]
%
...
% diary(sprintf('/home/gc3-user/HIFONASHE-02/Analysis/Balazs_Laurenczy/2015/1502_chronic/B/%s_batchSave.log', datestr(now, 'yyyymmdd_HHMMSS')));
...
%     arrayfun(@(day) sprintf('2015_04_%02d', day), [2, 10, 16, 24, 27], 'UniformOutput', false) ...
    arrayfun(@(day) sprintf('2015_03_%02d', day), 25, 'UniformOutput', false), ...
    arrayfun(@(day) sprintf('2015_04_%02d', day), [2, 10], 'UniformOutput', false) ...
];
        ...
        for iDay = 1 : nDays;
            ...
            for iSpot = 1 : nSpots;
                ...
                try
                    ...
                    this = OCIA('batchSave_gc3_b', { animalID, dayID, spotID, '', 'ROISet ~= \w+' });
