function OCIA_loadData_wfRef(this, iDWRow, loadType)
% OCIA_loadData_wfRef - [no description]
%
%       OCIA_loadData_wfRef(this, iDWRow, loadType)
%
% [No description]
%
...
isDataLoaded = false;
currRawLoadStatus = getData(this, iDWRow, 'wfRef', 'loadStatus');
...
if ~isDataLoaded;
    ...
    % store the data
    setData(this, iDWRow, 'wfRef', 'data', data);
    setData(this, iDWRow, 'wfRef', 'loadStatus', iff(strcmp(currRawLoadStatus, 'full'), 'full', loadType));
