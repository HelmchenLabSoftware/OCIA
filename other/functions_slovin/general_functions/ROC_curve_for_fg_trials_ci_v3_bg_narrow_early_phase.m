...
fg_c1c=squeeze(mean(mean(cond1n_dt_bl(roi_contour2,32:42,:),1),2))-squeeze(mean(mean(cond1n_dt_bl(roi_maskin_narrow,32:42,:),1),2));
fg_c2c=squeeze(mean(mean(cond2n_dt_bl(roi_contour2,32:42,:),1),2))-squeeze(mean(mean(cond2n_dt_bl(roi_maskin_narrow,32:42,:),1),2));
fg_c4c=squeeze(mean(mean(cond4n_dt_bl(roi_contour2,32:42,:),1),2))-squeeze(mean(mean(cond4n_dt_bl(roi_maskin_narrow,32:42,:),1),2));
fg_c5c=squeeze(mean(mean(cond5n_dt_bl(roi_contour2,32:42,:),1),2))-squeeze(mean(mean(cond5n_dt_bl(roi_maskin_narrow,32:42,:),1),2));
clear cond1n_dt_bl
clear cond2n_dt_bl
clear cond4n_dt_bl
clear cond5n_dt_bl
...
load cond5n_dt_bl
load('myrois.mat', 'roi_contour2', 'roi_maskin_narrow')
fg_c1d=squeeze(mean(mean(cond1n_dt_bl(roi_contour2,32:42,:),1),2))-squeeze(mean(mean(cond1n_dt_bl(roi_maskin_narrow,32:42,:),1),2));
fg_c2d=squeeze(mean(mean(cond2n_dt_bl(roi_contour2,32:42,:),1),2))-squeeze(mean(mean(cond2n_dt_bl(roi_maskin_narrow,32:42,:),1),2));
fg_c4d=squeeze(mean(mean(cond4n_dt_bl(roi_contour2,32:42,:),1),2))-squeeze(mean(mean(cond4n_dt_bl(roi_maskin_narrow,32:42,:),1),2));
fg_c5d=squeeze(mean(mean(cond5n_dt_bl(roi_contour2,32:42,:),1),2))-squeeze(mean(mean(cond5n_dt_bl(roi_maskin_narrow,32:42,:),1),2));
clear cond1n_dt_bl
clear cond2n_dt_bl
clear cond4n_dt_bl
clear cond5n_dt_bl
...
fg_c1h=squeeze(mean(mean(cond1n_dt_bl(roi_contour,32:42,:),1),2))-squeeze(mean(mean(cond1n_dt_bl(roi_maskin_narrow,32:42,:),1),2));
fg_c2h=squeeze(mean(mean(cond2n_dt_bl(roi_contour,32:42,:),1),2))-squeeze(mean(mean(cond2n_dt_bl(roi_maskin_narrow,32:42,:),1),2));
fg_c4h=squeeze(mean(mean(cond4n_dt_bl(roi_contour,32:42,:),1),2))-squeeze(mean(mean(cond4n_dt_bl(roi_maskin_narrow,32:42,:),1),2));
fg_c5h=squeeze(mean(mean(cond5n_dt_bl(roi_contour,32:42,:),1),2))-squeeze(mean(mean(cond5n_dt_bl(roi_maskin_narrow,32:42,:),1),2));
clear cond1n_dt_bl
clear cond2n_dt_bl
clear cond4n_dt_bl
clear cond5n_dt_bl
...
load cond5n_dt_bl
load('myrois.mat', 'roi_circle_diff', 'roi_bg_in_narrow')
fg_c1d=squeeze(mean(mean(cond1n_dt_bl(roi_circle_diff,32:42,:),1),2))-squeeze(mean(mean(cond1n_dt_bl(roi_bg_in_narrow,32:42,:),1),2));
fg_c5d=squeeze(mean(mean(cond5n_dt_bl(roi_circle_diff,32:42,:),1),2))-squeeze(mean(mean(cond5n_dt_bl(roi_bg_in_narrow,32:42,:),1),2));
clear cond1n_dt_bl
clear cond5n_dt_bl
%e
...
load cond5n_dt_bl
load('myrois.mat', 'roi_circle_diff', 'roi_bg_in_narrow')
fg_c1e=squeeze(mean(mean(cond1n_dt_bl(roi_circle_diff,32:42,:),1),2))-squeeze(mean(mean(cond1n_dt_bl(roi_bg_in_narrow,32:42,:),1),2));
fg_c5e=squeeze(mean(mean(cond5n_dt_bl(roi_circle_diff,32:42,:),1),2))-squeeze(mean(mean(cond5n_dt_bl(roi_bg_in_narrow,32:42,:),1),2));
clear cond1n_dt_bl
clear cond5n_dt_bl
%f
...
load cond5n_dt_bl
load('myrois.mat', 'roi_circle_diff', 'roi_bg_in_narrow')
fg_c1f=squeeze(mean(mean(cond1n_dt_bl(roi_circle_diff,32:42,:),1),2))-squeeze(mean(mean(cond1n_dt_bl(roi_bg_in_narrow,32:42,:),1),2));
fg_c5f=squeeze(mean(mean(cond5n_dt_bl(roi_circle_diff,32:42,:),1),2))-squeeze(mean(mean(cond5n_dt_bl(roi_bg_in_narrow,32:42,:),1),2));
clear cond1n_dt_bl
clear cond5n_dt_bl
