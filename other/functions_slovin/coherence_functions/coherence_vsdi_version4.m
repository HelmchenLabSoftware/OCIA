...
for i=[4 3 2 6]%condition count
    ...
    eval(['save test_coher_V1_cond',int2str(i),' coher_V1_cond',int2str(i),' roi_V1 pixels'])
    eval(['save test_coher_V1_std_cond',int2str(i),' coher_V1_std_cond',int2str(i),' roi_V1 pixels'])
...
for cond=[4 3 2 6]
    ...
    load (['test_coher_V1_cond',int2str(cond)])
    ...
    eval(['c(pixels,:,:)=coher_V1_cond',int2str(cond),';']);
    eval(['clear coher_V1_cond',int2str(cond)])
    c(roi_V1,:,:)=c(roi_V1,:,:)-a;
    c=c/(b*a);
    eval(['coher_V1_cond',int2str(cond),'=c(pixels,:,:);']);
    eval(['save test_coher_V1_cond',int2str(cond),' coher_V1_cond',int2str(cond),' roi_V1 pixels'])
    eval(['clear coher_V1_cond',int2str(cond)])
    clear c
end
