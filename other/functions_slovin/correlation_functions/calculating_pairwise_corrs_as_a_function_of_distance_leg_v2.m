...
coeff_bg_circ_cond1c=mean(coeff_maskin_contour2_cond1(:,:,tt),3);
clear coeff_maskin_contour2_cond1
load coeff_maskin_contour2_cond2
coeff_bg_circ_cond2c=mean(coeff_maskin_contour2_cond2(:,:,tt),3);
clear coeff_maskin_contour2_cond2
load coeff_maskin_contour2_cond4
coeff_bg_circ_cond4c=mean(coeff_maskin_contour2_cond4(:,:,tt),3);
clear coeff_maskin_contour2_cond4
load coeff_maskin_contour2_cond5
coeff_bg_circ_cond5c=mean(coeff_maskin_contour2_cond5(:,:,tt),3);
...
load coeff_maskin_contour2_cond1
coeff_bg_circ_cond1d=mean(coeff_maskin_contour2_cond1(:,:,tt),3);
clear coeff_maskin_contour2_cond1
load coeff_maskin_contour2_cond2
coeff_bg_circ_cond2d=mean(coeff_maskin_contour2_cond2(:,:,tt),3);
clear coeff_maskin_contour2_cond2
load coeff_maskin_contour2_cond4
coeff_bg_circ_cond4d=mean(coeff_maskin_contour2_cond4(:,:,tt),3);
clear coeff_maskin_contour2_cond4
load coeff_maskin_contour2_cond5
coeff_bg_circ_cond5d=mean(coeff_maskin_contour2_cond5(:,:,tt),3);
clear coeff_maskin_contour2_cond5
...
coeff_circ_cond1c=mean(coeff_contour2_cond1(:,:,tc),3);
clear coeff_contour2_cond1
load coeff_contour2_cond2
coeff_circ_cond2c=mean(coeff_contour2_cond2(:,:,tc),3);
clear coeff_contour2_cond2
load coeff_contour2_cond4
coeff_circ_cond4c=mean(coeff_contour2_cond4(:,:,tc),3);
clear coeff_contour2_cond4
load coeff_contour2_cond5
coeff_circ_cond5c=mean(coeff_contour2_cond5(:,:,tc),3);
clear coeff_contour2_cond5

cd F:\Data\VSDI\Contour_integration\legolas\right_hemisphere\11_11_2008\d\elhanan_new\pixelwise
load coeff_contour2_cond1
coeff_circ_cond1d=mean(coeff_contour2_cond1(:,:,tc),3);
clear coeff_contour2_cond1
load coeff_contour2_cond2
coeff_circ_cond2d=mean(coeff_contour2_cond2(:,:,tc),3);
clear coeff_contour2_cond2
load coeff_contour2_cond4
coeff_circ_cond4d=mean(coeff_contour2_cond4(:,:,tc),3);
clear coeff_contour2_cond4
load coeff_contour2_cond5
coeff_circ_cond5d=mean(coeff_contour2_cond5(:,:,tc),3);
clear coeff_contour2_cond5
...
coeff_bg_cond1c=mean(coeff_maskin_cond1(:,:,tb),3);
clear coeff_maskin_cond1
load coeff_maskin_cond2
coeff_bg_cond2c=mean(coeff_maskin_cond2(:,:,tb),3);
clear coeff_maskin_cond2
load coeff_maskin_cond4
coeff_bg_cond4c=mean(coeff_maskin_cond4(:,:,tb),3);
clear coeff_maskin_cond4
load coeff_maskin_cond5
coeff_bg_cond5c=mean(coeff_maskin_cond5(:,:,tb),3);
clear coeff_maskin_cond5

cd F:\Data\VSDI\Contour_integration\legolas\right_hemisphere\11_11_2008\d\elhanan_new\no_stim\pixelwise

load coeff_maskin_cond1
coeff_bg_cond1d=mean(coeff_maskin_cond1(:,:,tb),3);
clear coeff_maskin_cond1
load coeff_maskin_cond2
coeff_bg_cond2d=mean(coeff_maskin_cond2(:,:,tb),3);
clear coeff_maskin_cond2
load coeff_maskin_cond4
coeff_bg_cond4d=mean(coeff_maskin_cond4(:,:,tb),3);
clear coeff_maskin_cond4
load coeff_maskin_cond5
coeff_bg_cond5d=mean(coeff_maskin_cond5(:,:,tb),3);
clear coeff_maskin_cond5
...
save corr_bg_circ_1111cd_no_stim cont_bg_circ non_bg_circ
save corr_circ_circ_1111cd_no_stim cont_circ_circ non_circ_circ
save corr_bg_bg_1111cd_no_stim cont_bg_bg non_bg_bg
...
coeff_bg_circ_cond1=mean(coeff_maskin_contour_cond1(:,:,tt),3);
clear coeff_maskin_contour_cond1
load coeff_maskin_contour_cond2
coeff_bg_circ_cond2=mean(coeff_maskin_contour_cond2(:,:,tt),3);
clear coeff_maskin_contour_cond2
load coeff_maskin_contour_cond4
coeff_bg_circ_cond4=mean(coeff_maskin_contour_cond4(:,:,tt),3);
clear coeff_maskin_contour_cond4
load coeff_maskin_contour_cond5
coeff_bg_circ_cond5=mean(coeff_maskin_contour_cond5(:,:,tt),3);
...
coeff_circ_circ_cond1=mean(coeff_contour_cond1(:,:,tc),3);
clear coeff_contour_cond1
load coeff_contour_cond2
coeff_circ_circ_cond2=mean(coeff_contour_cond2(:,:,tc),3);
clear coeff_contour_cond2
load coeff_contour_cond4
coeff_circ_circ_cond4=mean(coeff_contour_cond4(:,:,tc),3);
clear coeff_contour_cond4
load coeff_contour_cond5
coeff_circ_circ_cond5=mean(coeff_contour_cond5(:,:,tc),3);
...
load coeff_maskin_cond1
coeff_bg_bg_cond1=mean(coeff_maskin_cond1(:,:,tb),3);
clear coeff_maskin_cond1
load coeff_maskin_cond2
coeff_bg_bg_cond2=mean(coeff_maskin_cond2(:,:,tb),3);
clear coeff_maskin_cond2
load coeff_maskin_cond4
coeff_bg_bg_cond4=mean(coeff_maskin_cond4(:,:,tb),3);
clear coeff_maskin_cond4
load coeff_maskin_cond5
coeff_bg_bg_cond5=mean(coeff_maskin_cond5(:,:,tb),3);
clear coeff_maskin_cond5
...
coeff_bg_circ_cond1=mean(coeff_bg_in_circle_diff_cond1(:,:,tt),3);
clear coeff_bg_in_circle_diff_cond1
load coeff_bg_in_circle_diff_cond5
coeff_bg_circ_cond5=mean(coeff_bg_in_circle_diff_cond5(:,:,tt),3);
...
coeff_circ_circ_cond1=mean(coeff_circle_diff_cond1(:,:,tc),3);
clear coeff_circle_diff_cond1
load coeff_circle_diff_cond5
coeff_circ_circ_cond5=mean(coeff_circle_diff_cond5(:,:,tc),3);
...
coeff_bg_bg_cond1=mean(coeff_bg_in_cond1(:,:,tb),3);
clear coeff_bg_in_cond1
load coeff_bg_in_cond5
coeff_bg_bg_cond5=mean(coeff_bg_in_cond5(:,:,tb),3);
...
coeff_bg_circ_cond2=mean(coeff_bg_in_circle_diff_cond2(:,:,tt),3);
clear coeff_bg_in_circle_diff_cond2
load coeff_bg_in_circle_diff_cond4
coeff_bg_circ_cond4=mean(coeff_bg_in_circle_diff_cond4(:,:,tt),3);
...
coeff_circ_circ_cond2=mean(coeff_circle_diff_cond2(:,:,tc),3);
clear coeff_circle_diff_cond2
load coeff_circle_diff_cond4
coeff_circ_circ_cond4=mean(coeff_circle_diff_cond4(:,:,tc),3);
...
coeff_bg_bg_cond2=mean(coeff_bg_in_cond2(:,:,tb),3);
clear coeff_bg_in_cond2
load coeff_bg_in_cond4
coeff_bg_bg_cond4=mean(coeff_bg_in_cond4(:,:,tb),3);
