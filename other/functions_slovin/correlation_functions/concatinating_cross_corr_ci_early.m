...
load crv_rois_1111cd_early
crv_cont_circ=crv_cont_contour2;
crv_cont_bg=crv_cont_maskin;
crv_non_circ=crv_non_contour2;
crv_non_bg=crv_non_maskin;
clear crv_cont_contour2 crv_non_contour2 crv_cont_maskin crv_non_maskin
...
%%
t=-150:10:150;
figure;errorbar(t,mean(crv_cont_circ,2),std(crv_cont_circ,0,2)/sqrt(size(crv_cont_circ,2)))
hold on
errorbar(t,mean(crv_non_circ,2),std(crv_non_circ,0,2)/sqrt(size(crv_non_circ,2)),'r')

t=-150:10:150;
figure;errorbar(t,mean(crv_cont_bg,2),std(crv_cont_bg,0,2)/sqrt(size(crv_cont_bg,2)))
hold on
errorbar(t,mean(crv_non_bg,2),std(crv_non_bg,0,2)/sqrt(size(crv_non_bg,2)),'r')
...
signrank(mean(diff_circ(13:19,:),1))
signrank(mean(diff_bg(13:19,:),1))

signrank(mean(diff_circ(3:8,:),1))
signrank(mean(diff_bg(3:8,:),1))

signrank(mean(diff_circ(24:29,:),1))
signrank(mean(diff_bg(24:29,:),1))

signrank(mean(diff_circ([3:8 24:29],:),1))
signrank(mean(diff_bg([3:8 24:29],:),1))
