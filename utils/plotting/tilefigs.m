function tilefigs(figs, hideMenuAndToolbar)
...
% modified by Henry Luetcke, 2010-04-15
% modified by Balazs Laurenczy, 2013-09-11

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Get the handles to the figures to process.
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

if ~nargin || strcmp(figs, 'all')       % If no input arguments...
   figs = findobj('Type', 'figure');	% ...find all figures.
   figs	= sort(figs);
end

if nargin < 2;
   hideMenuAndToolbar = 0;
end;
...
for row = 1 : nv
   for col = 1 : nh
     ...
     % modifed blaurenczy::2013-09-11
     if hideMenuAndToolbar;
        set(fighnd, 'MenuBar', 'none');	      % hide menubar
     else
        set(fighnd, 'MenuBar', 'figure');	  % show menubar
     end;
...
% 	 set(fighnd, 'OuterPosition', [0 0 1 1]);	      % Set position.
	 set(fighnd, 'Units', old_fig_units);	      % Reset units.
%      % modifed hluetck::2010-04-15
%      legend('off')
