function hpol = customPolar(varargin)
...
%         c82 = cos(82 * pi / 180);
%         s82 = sin(82 * pi / 180);
        c82 = cos((360 / size(rho, 2)) * pi / 180) * 0.95;
        s82 = sin((360 / size(rho, 2)) * pi / 180) * 0.95;
        ...
        % plot spokes, new way
        nStim = size(rho, 2);
        th = (1 : nStim) * 2 * pi / nStim;
        cst = cos(th);
        snt = sin(th);
        cs = vertcat(zeros(1, nStim), cst);
        sn = vertcat(zeros(1, nStim), snt);
