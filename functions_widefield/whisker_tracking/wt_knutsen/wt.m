...
g_tWT.VerboseMode = 0;
g_tWT.EyeFilter=wt_create_filter(struct('Size', 14, 'Sigma_A', 3, 'Sigma_B', .5), 'create-only'); % default eye-tracker filter
g_tWT.LabelFilter=wt_create_filter(struct('Size', 10, 'Sigma_A', 1, 'Sigma_B', 2), 'create-only'); % default whisker-label filter
g_tWT.Movies = [];
