 	...
 	B. Set the path by doing one of the following:
		...
		* Add the MCR directory to the environment variable by issuing 
         ...
         NOTE: When deploying C and C++ standalone applications, it is possible
               to run the shell script file run_unite_data_cond1_V1.sh on UNIX and Mac
...
3. Collect the following files, based on what you are deploying: 
	...
	All Platforms:
		* unite_data_cond1_V1.ctf (Component Technology File archive,
		  platform-dependent on target machine)
			
        Windows:
		* MCRInstaller.exe (self-extracting MATLAB Component Runtime
		  library installer)   
		* unite_data_cond1_V1.exe (application created by MATLAB Compiler)
        UNIX:
		* MCRInstaller.bin (MATLAB Component Runtime library 
	 	  installer)
		* unite_data_cond1_V1 (application created by MATLAB Compiler)
		* run_unite_data_cond1_V1.sh (shell script that can be run 
	...
	All Platforms:            
		* unite_data_cond1_V1.so (shared library, file extension 
		  varies by platform)
		* unite_data_cond1_V1.h (library header file)
		* unite_data_cond1_V1.ctf (Component Technology File archive,
	...
	* unite_data_cond1_V1.xml (documentation files)
	* unite_data_cond1_V1.pdb (program database file - if 
	  DEBUG option selected)
	* unite_data_cond1_V1.dll (component assembly file)
	* MCRInstaller.exe (self-extracting MATLAB Component Runtime
	  library archive)  
	...
	* unite_data_cond1_V1.ctf (Component Technology File archive, 
	  contains compiled M-code)
	* unite_data_cond1_V1_1_0.dll (COM component)
	* MCRInstaller.exe (self-extracting MATLAB Component Runtime
	  library archive)  	
	...
	* unite_data_cond1_V1.jar (Java class files and compiled M-code)
	...
	* unite_data_cond1_V1.ctf (Component Technology File archive, 
	  contains compiled M-code)
	* unite_data_cond1_V1.xla (Optionally created and placed in
